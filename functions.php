...
function shoreditch_scripts() {
	...
	wp_enqueue_style( 'genericons', get_template_directory_uri() . '/vendor/genericons/genericons.css', array(), '3.4.1' );

	wp_enqueue_style( 'shoreditch-fonts', shoreditch_fonts_url(), array(), null );

	wp_enqueue_style( 'shoreditch-style', get_stylesheet_directory_uri() . "/style{$suffix}.css" );

	wp_enqueue_script( 'shoreditch', get_template_directory_uri() . "/assets/scripts/project{$suffix}.js", array( 'jquery' ), filemtime( get_template_directory() . "/assets/scripts/project{$suffix}.js" ), true );

	if ( get_theme_mod( 'shoreditch_sticky_header' ) ) {
		wp_enqueue_script( 'shoreditch-header', get_template_directory_uri() . "/assets/scripts/header{$suffix}.js", array(), filemtime( get_template_directory() . "/assets/scripts/header{$suffix}.js" ), true );
	}
	...
	wp_localize_script( 'shoreditch', 'buttonTitle', array(
		'desc' => esc_html__( 'Back to top', 'shoreditch' ),
	) );

	wp_localize_script( 'shoreditch', 'screenReaderText', array(
