...
Essex is a fork of Automattic's [Shoreditch](https://wordpress.com/themes/shoreditch/) theme. It looks and functions the same, but uses SASS for styling and has its CSS and JavaScript files concatenated and minified where possible for better performance.

Just like Shoreditch, Essex is a functional and responsive theme perfect for your business’s online presence. Although its main purpose is business, it looks great as a personal blog theme too.
...
* Based on the Shoreditch theme by Automattic – https://wordpress.com/themes/shoreditch/
